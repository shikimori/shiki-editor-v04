...
import { NodeSelection, EditorState, TextSelection } from 'prosemirror-state';
import { EditorView } from 'prosemirror-view';
import { Mark as Mark$1, Schema } from 'prosemirror-model';
import { keymap } from 'prosemirror-keymap';
import { toggleMark, setBlockType, lift, wrapIn, joinBackward, baseKeymap } from 'prosemirror-commands';
import { InputRule, wrappingInputRule, textblockTypeInputRule, inputRules } from 'prosemirror-inputrules';
...
import { pushScopeId, popScopeId, openBlock, createBlock, createVNode, withScopeId } from 'vue';
import { icons as icons$1, undoItem, redoItem, MenuItem, menuBar } from 'prosemirror-menu';
...
var CodeBlock = /*#__PURE__*/function (_Node) {
  ...
  _createClass(CodeBlock, [{
    ...
    value: function inputRules(_ref2) {
      var type = _ref2.type;
      return [textblockTypeInputRule(/^```\w* $/, type, function (match) {
        return {
...
var script = {
  ...
  methods: {
    ...
    select: function select() {
      this.view.dispatch(this.view.state.tr.setSelection(new NodeSelection(this.view.state.tr.doc.resolve(this.getPos()))));
    }
  }
};

var _withId = /*#__PURE__*/withScopeId("data-v-1dc8d709");

pushScopeId("data-v-1dc8d709");
...
var icons = _objectSpread2(_objectSpread2({}, icons$1), {}, {
  code_inline: icons$1.code,
  bullet_list: icons$1.bulletList,
  bold: {
    width: 384,
    height: 512,
...
undoItem.spec.title = function () {
  return I18n.t('frontend.shiki_editor.undo');
};

redoItem.spec.title = function () {
...
function maybeMerge(a, b) {
  if (a.isText && b.isText && Mark$1.sameSet(a.marks, b.marks)) { return a.withText(a.text + b.text); }
...
var ShikiEditor = (_class = (_temp = /*#__PURE__*/function (_Emitter) {
  ...
  _createClass(ShikiEditor, [{
    ...
    value: function createPlugins() {
      return [].concat(_toConsumableArray(this.extensions.plugins), [history(), buildMenu(this), inputRules({
  ...
  return ShikiEditor;
}(Emitter), _temp), (_applyDecoratedDescriptor(_class.prototype, "dispatchTransaction", [bind], Object.getOwnPropertyDescriptor(_class.prototype, "dispatchTransaction"), _class.prototype)), _class);
...
export { ShikiEditor as Editor, editor_content as EditorContent };
